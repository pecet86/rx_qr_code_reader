package pl.pecet.rx_code_reader.example;

import static android.widget.Toast.LENGTH_SHORT;
import static android.widget.Toast.makeText;
import static autodispose2.AutoDispose.autoDisposable;
import static pl.pecet.rx_code_reader.example.R.id.button_read_ean;
import static pl.pecet.rx_code_reader.example.R.id.button_read_qr_code;
import static pl.pecet.rx_code_reader.example.R.id.button_read_qr_code_block_orientation;
import static pl.pecet.rx_code_reader.example.R.id.button_read_qr_code_url;
import static pl.pecet.rx_code_reader.example.R.id.ean_code_fragment;
import static pl.pecet.rx_code_reader.example.R.id.qr_code_fragment;
import static pl.pecet.rx_code_reader.example.R.layout.activity_main;
import static pl.pecet.rx_code_reader.qr.api.QrCodeConfig.FLASH_MODE_OFF;
...
import pl.pecet.rx_code_reader.ean.api.RxEanCode;
import pl.pecet.rx_code_reader.qr.api.QrCodeConfig;
import pl.pecet.rx_code_reader.qr.api.RxQrCode;
